...
pub enum CharacterState {
    ...
    SWALLOW_GROUND_CAPTURED,
    SWALLOW_GROUND_CAPTURE_WAIT,
    SWALLOW_CAPTURE_WALK_SLOW,
    SWALLOW_CAPTURE_WALK_MIDDLE,
    SWALLOW_CAPTURE_WALK_FAST,
    SWALLOW_GROUND_CAPTURE_TURN,
    SWALLOW_CAPTURE_JUMP_SQUAT,
    SWALLOW_CAPTURE_JUMP,
    SWALLOW_CAPTURE_LANDING,
    ...
    SWALLOW_AIR_END,
    SWALLOW_AIR_CAPTURE,
    SWALLOW_AIR_CAPTURED,
    SWALLOW_AIR_CAPTURE_WAIT,
    SWALLOW_AIR_DIGEST,
    SWALLOW_AIR_SPIT,
    SWALLOW_AIR_CAPTURE_TURN,
    HAMMER_GROUND,
    HAMMER_AIR,
    ...
    SAMUS_CHARGE_SHOT_GROUND_FIRE,
    SAMUS_CHARGE_SHOT_AIR_START,
    SAMUS_CHARGE_SHOT_AIR_FIRE,
    ...
    FOX_BLASTER_AIR_END,
    PIKACHU_THUNDER_JOLT_GROUND,
    PIKACHU_THUNDER_JOLT_AIR,
    LUIGI_FIREBALL_GROUND,
    LUIGI_FIREBALL_AIR,
    FALCON_FALCON_PUNCH_GROUND,
    FALCON_FALCON_PUNCH_AIR,
    ...
    SHEIK_NEEDLE_STORM_GROUND_START_CHARGE,
    SHEIK_NEEDLE_STORM_GROUND_CHARGE_LOOP,
    SHEIK_NEEDLE_STORM_GROUND_END_CHARGE,
    SHEIK_NEEDLE_STORM_GROUND_FIRE,
    SHEIK_NEEDLE_STORM_AIR_START_CHARGE,
    SHEIK_NEEDLE_STORM_AIR_CHARGE_LOOP,
    SHEIK_NEEDLE_STORM_AIR_END_CHARGE,
    SHEIK_NEEDLE_STORM_AIR_FIRE,
    ...
    MEWTWO_SHADOW_BALL_GROUND_FIRE,
    ...
    MEWTWO_SHADOW_BALL_AIR_FIRE,
    GAMEAND_WATCH_OIL_PANIC_GROUND,
    GAMEAND_WATCH_OIL_PANIC_AIR,
    DOC_MEGAVITAMIN_GROUND,
    DOC_MEGAVITAMIN_AIR,
    YOUNG_LINK_FIRE_BOW_GROUND_CHARGE,
    YOUNG_LINK_FIRE_BOW_GROUND_FULLY_CHARGED,
    YOUNG_LINK_FIRE_BOW_GROUND_FIRE,
    YOUNG_LINK_FIRE_BOW_AIR_CHARGE,
    YOUNG_LINK_FIRE_BOW_AIR_FULLY_CHARGED,
    YOUNG_LINK_FIRE_BOW_AIR_FIRE,
    ...
    PICHU_THUNDER_JOLT_GROUND,
    PICHU_THUNDER_JOLT_AIR,
    ...
    CHARGE_SHOT_GROUND_FIRE,
    CHARGE_SHOT_AIR_START,
    CHARGE_SHOT_AIR_FIRE,
    MISSILE_GROUND,
    ...
    // Sheik
    NEEDLE_STORM_GROUND_START_CHARGE,
    NEEDLE_STORM_GROUND_CHARGE_LOOP,
    NEEDLE_STORM_GROUND_END_CHARGE,
    NEEDLE_STORM_GROUND_FIRE,
    NEEDLE_STORM_AIR_START_CHARGE,
    NEEDLE_STORM_AIR_CHARGE_LOOP,
    NEEDLE_STORM_AIR_END_CHARGE,
    NEEDLE_STORM_AIR_FIRE,
...
impl CharacterState {
    pub fn from_char_and_state(character: Character, state: u16) -> Self {
        ...
        match character {
            ...
            Character::Popo | Character::IceClimbers => match state {
                341 => ICE_SHOT_GROUND,
                342 => ICE_SHOT_AIR,
            ...
            Character::Nana => match state {
                ...
                _ => panic!("Invalid state value for {character}. Value must be in range 341-365 inclusive. Got: {state}")
            },
